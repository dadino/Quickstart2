...
open class RecyclerLayout<T : BaseAdapter<*, *>, E : RecyclerView.LayoutManager> :
    SwipeRefreshLayout {
    ...
    private var mEmptyIsInstruction: Boolean = false
    ...
    private fun updateEmptyTextVisibility() {
        ...
        val shouldBeGone = mEmptyIsInstruction.not() && (emptyAdapter.not() || mLoading)
